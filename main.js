 ...
 function getUserChoice (userInput) { 
   if (userInput === "rock") {
    ...
    return scissors
     ...
     console.log( "Your selection was invalid. Please choose rock, paper, or scissors.")
...
//  }
    let mathInput = (Math.floor(Math.random() * 10) {
      
     if (mathInput <=3) {
      return 0
     }
     else if (mathInput > 3 && mathInput <=6) {
     return 1
     }
    else {
     return 2 
    ...
    function getComputerChoice (mathInput) { 
     if (mathInput === 0) {
       return "rock"
     }
    else if (mathInput === 1) {
...
// Step 6. Test the function by calling it multiple times and printing the results to the console.

// You can delete this when you know your function works.

// Step 7. Now it’s time to determine a winner.

    function determineWinner ( getsUserChoice , getComputerChoice) {
      if  {getsUserChoice = getComputerChoice
      } return "it's a draw!"
      
      else if {
        getsUserChoice === rock && getComputerChoice === paper 
      } return "player lost"
      
      else if {
        getsUserChoice === rock && getComputerChoice === scissors 
      }return "player wins"
      
      else if {
        getsUserChoice === paper && getComputerChoice === scissors 
      }return "player lost"
      
      else if {
        getsUserChoice === paper && getComputerChoice === rock 
      }return "player wins"
      
      else if {
        getsUserChoice === scissors && getComputerChoice === rock 
      }return "player lost"
      
      else if {
        getsUserChoice === scissors && getComputerChoice === paper
      }return "player wins"
...
// Step 8. If the game is not a tie, you’ll need to determine a winner.
...
// Step 15. Turn your project in here: https://parsity.typeform.com/to/oNdpq275        
